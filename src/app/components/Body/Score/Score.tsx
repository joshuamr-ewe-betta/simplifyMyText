...
function getScore(reduction: number): number {
  ...
  if (reduction >= 80 && reduction < 100) return 1;
  if (reduction >= 60 && reduction < 80) return 2;
  if (reduction >= 50 && reduction < 60) return 3;
  if (reduction >= 40 && reduction < 50) return 4;
  if (reduction >= 30 && reduction < 40) return 5;
  if (reduction >= 20 && reduction < 30) return 6;
  if (reduction >= 15 && reduction < 20) return 7;
  if (reduction >= 10 && reduction < 15) return 8;
  if (reduction >= 5 && reduction < 10) return 9;
  if (reduction >= 5 && reduction < 10) return 9;
  return 10;
}
